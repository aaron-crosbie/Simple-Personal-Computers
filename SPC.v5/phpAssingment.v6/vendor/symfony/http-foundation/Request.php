...
class Request
{
     ...
     *
     * Suppose that an index.html.twig file instantiates this request object:
     *
     *  * http://localhost/index.html.twig         returns an empty string
     *  * http://localhost/index.html.twig/page    returns an empty string
     *  * http://localhost/web/index.html.twig     returns '/web'
     *  * http://localhost/we%20b/index.html.twig  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
     ...
     * script filename (e.g. index.html.twig) if one exists.
     *
