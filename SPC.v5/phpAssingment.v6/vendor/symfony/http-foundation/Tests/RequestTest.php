...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $server['PATH_TRANSLATED'] = 'redirect:/index.html.twig/path/info';
        ...
        $this->assertEquals('http://host:8080/index.html.twig/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/index.html.twig/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $server['SCRIPT_NAME'] = '/index.php';
        $server['PHP_SELF'] = '/index.php';
        $server['SCRIPT_FILENAME'] = '/some/where/index.html.twig';
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/index.html.twig',
