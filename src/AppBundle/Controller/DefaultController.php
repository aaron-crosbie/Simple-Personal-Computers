...
class DefaultController extends Controller
{
    ...
    public function accountAction(Request $request)
    {
        ...
        $blogPosts = $em->getRepository('AppBundle:BlogPost')->findBy(array('user' => $this->get('security.token_storage')->getToken()->getUser()));

        $blogComments = $em->getRepository('AppBundle:BlogComment')->findBy(array('author' => $this->get('security.token_storage')->getToken()->getUser()));
    ...
    /**
     * @Route("/document", name="documentpage")
     */
